...
<!-- 메인 컨텐트 시작 -->
	<main role="main" class="container">
		...
		<div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<table class="table table-striped">
				...
				<!-- 리스트 시작 -->
				<c:forEach items="${ledLogListView.list}" var="ledLog">
				<tr>
					<td>${ledLog.ledLogIdx}</td>
					<td>${ledLog.ledLogDate}</td>
					<td><a href="<c:url value="/led/ledLogDetailView?ledLogIdx=${ledLog.ledLogIdx}"/>">자세히 보기</a></td>
				</tr>
				</c:forEach>
				<!-- 리스트 끝-->
			</table>
	...
	<%-- 		<div>
			...
			<nav aria-label="Page navigation example">
		 	 <ul class="pagination">
		    <li class="page-item">		
		     <c:forEach begin="1" end="${ledLogListView.totalPageCount}" var="i">
		<li class="page-item"><a  class="page-link"  href="<c:url value ="/led/ledLogList?page=${i}"/>">${i}</a></li>
				</c:forEach>
