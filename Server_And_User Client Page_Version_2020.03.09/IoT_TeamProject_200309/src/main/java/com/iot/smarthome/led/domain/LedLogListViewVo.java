...
//LedLogListViewVo: LED 로그를 보기 위해 저장되어 있던 데이터를 담는 도메인 클래스
public class LedLogListViewVo {
	//사진, 영상 리스트
	private List<LedLogEditVo> list;
	...
	public LedLogListViewVo(List<LedLogEditVo> list, int totalArticleCount, int currentPageNo, int startRow, int countPerPage) {
		super();
		this.list = list;
	...
	//get메서드
	//getter만 생성하였다.
	public List<LedLogEditVo> getList() {
		return list;
	}
	...
	public String toString() {
		return "LedLogListViewVo [list=" + list + ", totalArticleCount=" + totalArticleCount + ", totalPageCount="
