...
public class CctvListViewVo {
	...
	public CctvListViewVo(List<CctvEditVo> list, int totalArticleCount, int currentPageNo, int startRow, int countPerPage) {
		super();
		this.list = list;
	...
	//get메서드
	//getter만 생성하였다.
	public List<CctvEditVo> getList() {
		return list;
	}
	...
	public String toString() {
		...
		return "CctvListView [list=" + list + ", totalArticleCount=" + totalArticleCount + ", totalPageCount=" + totalPageCount + ", currentPageNo=" + currentPageNo + ", startRow=" + startRow + ", countPerPage=" + countPerPage + "]";
